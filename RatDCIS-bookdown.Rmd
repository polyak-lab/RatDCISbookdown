...
>>>>>>> 13ab65ea5f934862ef9c12e95357e1931225f8b2
```
...
=======
GlistGrowing=rownames(vstLumRes)[which(vstLumRes$padj<0.05 & (vstLumRes$log2FoldChange)>0.20 & vstLumRes$baseMean>100)]
Glistnon=rownames(vstLumRes)[which(vstLumRes$padj<0.05 & (vstLumRes$log2FoldChange)<(-0.20) & vstLumRes$baseMean>100)]
>>>>>>> 13ab65ea5f934862ef9c12e95357e1931225f8b2

write.csv(GlistGrowing,file="figure-outputs/lumsig_posFC.csv" )
write.csv(Glistnon,file="figure-outputs/lumsig_negFC.csv" )

ColSideCols=cut(vstLumOnly$GrowthRate, c(-1, 2, 5, 10, 20), c("L", "M", "O1", "O2"))
pdf("figure-outputs/Figure5_XX_heatmap_lumonly_growing_vs_stable.pdf", height=9, width=5)
...
=======
newinfoTab=data.frame(pat=BrClin$Patient.ID[l1], TCGAstab=TCGAssgsea[2, lx2],
                      TCGAgrow=TCGAssgsea[1, lx2],
                      TCGAcomb=TCGAssgsea[1, lx2]-TCGAssgsea[2, lx2],
                      Onco=TCGAssgsea[3, lx2],
                      Mamma=TCGAssgsea[4, lx2],
...
<<<<<<< HEAD
=======
### Redo the survival plots based on Luminal cases only
