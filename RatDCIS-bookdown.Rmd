...
#head(T2)
barplot(T2[1:20], ylim=c(0, 14), main="top 20 most frequent coding mutations with human homolog")
```
...
These are the interesting plots:
...
<!--chapter:end:12-trichrome-staining.Rmd-->
