...
DT::datatable(as.data.frame(valuesB), rownames=F, class='cell-border stripe',
          extensions="Buttons", options=list(dom="Bfrtip", buttons=c('csv', 'excel')))
...
DT::datatable(df.Spatial[ ,c("Trichrome", "Growth", "Treatment")], rownames=F, class='cell-border stripe',
          extensions="Buttons", options=list(dom="Bfrtip", buttons=c('csv', 'excel')))
