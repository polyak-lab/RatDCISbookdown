...
am1=lm(Cdata$Tumor.dia..sac..mm.[which(Cdata$Cohort!="Progression")]~
         Cdata$Time.NMU2Sac[which(Cdata$Cohort!="Progression")])

plot(jitter(Cdata$Time.NMU2Sac[which(Cdata$Cohort!="Progression")]),
     jitter(Cdata$Tumor.dia..sac..mm.[which(Cdata$Cohort!="Progression")]),
     xlab="Time from NMU to sac (days)", ylab="Tumor diameter (mm)", 
     col=ifelse(Cdata$Tumor.dia..sac..mm.[which(Cdata$Cohort!="Progression")]<X1a, ColSize[1], ColSize[2]), pch=19, main="characterisation: size over time")
abline(am1)
...
plot(jitter(Cdata$Time.NMU2Sac[which(Cdata$Cohort!="Progression")]),
     ...
     xlab="Time from NMU to sac (days)", ylab="Tumor diameter (mm)", 
     col=ifelse(Cdata$Tumor.dia..sac..mm.[which(Cdata$Cohort!="Progression")]<X1a, ColSize[1], ColSize[2]), pch=19, main="characterisation: size over time")
text(jitter(Cdata$Time.NMU2Sac[which(Cdata$Cohort!="Progression")])+5,
     jitter(Cdata$Tumor.dia..sac..mm.[which(Cdata$Cohort!="Progression")])+1,
     Cdata$TumorID[which(Cdata$Cohort!="Progression")], cex=0.7)
#dev.off()
```
...
```{r}
WSIvalsTS=t(t(WSIvals)/Cdata$Tumor.dia..sac..mm.[match(colnames(WSIvals), gsub("_", "", Cdata$TumorID))])
...
# Contingency Tables
par(mfrow=c(2,2))
a1=table(infoTableFinal$HR_pam, Cdata$PgR..IF.[match(infoTableFinal$TumorID, Cdata$TumorID)])
...
# Contingency Tables
par(mfrow=c(2,2))
a1=table(infoTableFinal$HR_pam, Cdata$ER..IF.[match(infoTableFinal$TumorID, Cdata$TumorID)])
