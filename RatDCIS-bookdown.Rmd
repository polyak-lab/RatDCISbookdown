...
```{r 5dAD, fig.cap="ADAMTS10 assoc with patient data"}
...
```{r 5eAD, fig.cap="forest plot ADAMTS10"}
...
#ax=cor.test(tinfoER$adamts10, tinfoER$strFrac, method="pearson")
#smoothScatter(tinfoER$adamts10, (tinfoER$leukFrac), xlab="gene exp", ylab="str frac")
text(4,0.2, sprintf("cor=%s, p=%s", round(ax$estimate, 2), round(ax$p.value, 2)))
...
pdf("figure-outputs/NEwpanelB2.pdf", height=6, width=5)
...
```{r 5h, fig.cap="luminal signature associated with clinical variables", fig.height=8}
...
write.csv(CD45res, file=sprintf("nature-tables/Supp2_difference_between_cd45characterisation-big-small%s.csv", Sys.Date()))
...
#boxplot(TrustTab[CD45F2 ,c("TrustGini")]~TrustTab[CD45F2, "Growth"], main=sprintf("Growth: Gini %s", round(a1[3], 2)),         ylab="gini", xlab="growth", col=ColSizeb)
#boxplot(TrustTab[CD45F2 ,c("TrustTop10")]~TrustTab[CD45F2, "Growth"],  main=sprintf("Growth: Top10", round(a1[4], 2)),ylab="top10 clonotypes", xlab="growth", col=ColSizeb)
...
```{r 3gb, fig.cap="Trichrome with growth", eval=F}
...
* Ext Fig 5B: [Expression of inflammatory genes across samples](#fig:Ext5b)
...
* Ext Fig 5I: [Trichrome association with inflammation and growth rate](#fig:Ext5i)
