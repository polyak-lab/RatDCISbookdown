...
paramDir<- "../bioclassifier_R" # the location of unchanging files such as the function library and main program
inputDir<- "."  # the location of the data matrix, and where output will be located

inputFile<- "../../../output4external/RSEM_for_PAM50_allExpressedgenes_noCD45_progressionapril_2020-11-03.txt" # the input data matrix as a tab delimited text file
short<-"RSEM_for_PAM50_allExpressedgenes_noCD45_progressionapril_2020-11-03" # short name that will be used for output files
