...
TermSelectionMap=function(topGSTerms, termi=1){
  ...
  RNAnames=c("_RNA", "TRANSCRIPT", "POL", "PROMOTER", "SPLIC", "EXON", "INTRON", "NONSENSE_MEDIATED", "3_UTR", "5_UTR",
             "GENE_EXPRESSION", "PPARA", "MRNA_", "_MRNA", "RRNA_PROCESSING")
  ...
  ImmTerms=c("IFN", "IL[0-9]","IL_[0-9]", "TNF", "CYTOKINE", "NKCELL", "ANTIGEN", "CHEMOKINE", "TCR", "BCR", "CYTOTOXIC",  "IMMUNE", "TH1", "STAT[0-9]", "INFLAMMATORY", "COMPLEMENT", "COAGULATION", "ALLOGRAFT","INTERFERON", "IGG","IGA_", "BCELL", "TCELL", "LYMPHOCYTE", "CTL", "TH2", "GRANZYME", "NEUTROPHIL", "T_CELL", "LEUKOCYTE", "B_CELL", "TREG", "INFLUENZA", "FC_", "IGF", "CLASSIC", "COMP_", "THROMBIN", "DEFENSIN", "ASTHMA", "LUPUS", "PDGF",  "TOLL", "ILS", "CCR", "MHC", "THELP", "TCAPOPTOSIS", "GMCSF", "GM_CSF", "CXCR", "CXCL", "MAST_CELL", "GRANULOCYTE", "TCAPOPTOSIS", "MONOCYTE", "INTEGRIN", "IMMUNO", "PD1_SI", "VIRION", "AUTOIMMUNE", "ALLOGRAFT","LYM_PATH",
             "CTL_PATHWAY","EPHA4_PATHWAY", "VIRAL",  "NFAT_", "HIV_", "GRAFT", "TCPTP", "TID_",
             "INTERLEUKIN", "HEMATOPOIETIC", "FCGR", "C4_AND_C2", "STEM_PATHWAY", "FCERI", "PEPI", "ANTIMICROBIAL_PROTEINS") #TID?FCERI_MEDIATED_CAPLUS2_MOBILIZATIONRUNX2
  ...
  ECMTerms=c("ECM", "EXTRACELLULAR", "MMP", "COLLAGEN", "MATRISOME", "KERATAN", "BASEMENT", "FRS2_", "ADHERENS", "PROTEOGLYCAN", "CELL2CELL", "ACTIN", "JUNCTION", "ADHESION", "INTEGRIN", 
             "LAMININ", "KERATIN", "AMYLOID", "CORNIFIED_ENVELOPE", "CILIUM_ASSEMBLY", "POTASSIUM_CHANNELS", "NCAM1")
  StressTerms=c("STRESS", "HIF", "HYPOXIA", "UPR", "UNFOLDED_PROTEIN", "ARF6", "ARF4")
  TFTerms=c("TF", "AR_TF")
  MetabTerms=c("METABOL", "GLUCOSE", "GLYCO", "PENTOSE", "TCA_", "PYRUVATE", "LIPID", "MITOCHON", "OXIDAT", "CARBOHYDRATE", "CREB", "CATABOL", 
               "CHOLESTER", "DIGESTION", "GLUCURONIDATION", "TRIACYLGLYCEROL", "BIOSYNTHESIS", "GLUCONEO", "DIABETES", "RECYCLING", "BETA_CELL", 
               "PTP1B", "INSULIN", "ELECTRON", "PYRIMIDINE_SALVAGE", "ACYL_CHAIN_RE", "CHYLOMICRON_CLEARANCE", "PHASE_II_CONJUGATION_OF_COMPOUNDS")
  #UBTerms=c("UBIQ", "PROTEASOME", "AUTOPHAGY", "INSULIN")
  APOPTOSIS=c("APOPTOSIS", "BCL", "D4GDI", "CELL_DEATH", "SENESCENCE")
  ANGIO=c("VEGF", "SCAVENGING_OF_HEME_FROM_PLASMA", "ENDOTHELIAL", "SPPA_PATHWAY","THROMBIN", "PAR1", "PLATELET", "ERYTHROCYTES")
  EXTRASIG=c("NEUROTRANSMITTER", "TRANSPORTER", "SECRETED", "GABA_", "CALCIUM", "K_CHANNEL","TRANSMEMBRANE",
             ...
             "CELL_SURFACE_INTERACTIONS", "PCP", "CHEMICAL_SYNAPSE", "STIMULI_SENSING_CHANNELS", "SCAVENGING", "SIGNAL", "LIGAND",
             "PHOSPHATASE", "ADAM", "SLRP", "PHEROMONE_RECEPTORS", "RHO_GTPASES")
  DIFFERENTIATION=c("SEMA3A")
  CELLstructure=c("ORGANELLE", "HEMOSTASIS")
  DISEASE=c("DISEASE", "TOXINS" )
  ...
  CellViability=topGSTerms[unlist(sapply(  CELLstructure, function(x) grep(x, topGSTerms)))]
  matrix2=matrix(0, ncol=14, nrow=length(topGSTerms))
  ...
  colnames(matrix2)=c("RNA","Protein","Immune",  "DNA/rep",  "Cancer","Metab", "ECM", "Stress", "EXSig",  "Apoptosis", "Angio", "Epi", 
                      "CellViability", "Disease")
  matrix2[match(ImmTerms2, rownames(matrix2)), 8]=termi*8
  matrix2[ match(DNATerms2, rownames(matrix2)), 4]=termi*4
  matrix2[ match(RNATerms2, rownames(matrix2)),1]=termi
  matrix2[ match(ProTerms2, rownames(matrix2)),2]=termi*2
  matrix2[ match(CancerTerms2, rownames(matrix2)),5]=termi*5
  matrix2[ match(ECMTerms2, rownames(matrix2)),7]=termi*7
  matrix2[ match(StressTerms2, rownames(matrix2)),9]=termi*9
  matrix2[ match(MetabTerms2, rownames(matrix2)),6]=termi*6
  matrix2[ match(EXS, rownames(matrix2)),3]=termi*3
  matrix2[ match(APOP, rownames(matrix2)),10]=termi*10
  matrix2[ match(ANG, rownames(matrix2)),11]=termi*11
  matrix2[ match(Methyl, rownames(matrix2)),12]=termi*12
  matrix2[ match(CellViability, rownames(matrix2)),13]=termi*13
  matrix2[ match(DISEASE, rownames(matrix2)),14]=termi*14
