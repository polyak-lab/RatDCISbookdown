...
ggplot(tablexM, aes(x=Treatment, y=value, col=Treatment))+geom_boxplot()+geom_point()+facet_grid(~varianle, scale="free_y", space="free_y")+scale_colour_manual(values=c(ColMerge[ ,1], "black"))+theme_bw()

write.csv(tableM, file="nature-tables/trust-treatment.csv")
...
ggplot(tablexM, aes(x=Growth, y=value, col=Growth))+geom_boxplot()+geom_point()+facet_grid(~varianle, scale="free_y", space="free_y")+scale_colour_manual(values=c(ColSizeb, "black"))+theme_bw()
